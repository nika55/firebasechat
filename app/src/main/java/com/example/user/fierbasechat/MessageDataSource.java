package com.example.user.fierbasechat;
...
public class MessageDataSource {
    private static final Firebase sRef = new Firebase("https://crackling-torch-2757.firebaseio.com/");
